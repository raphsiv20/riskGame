...
import org.example.vue.ConsulterPerformanceView;
...
/**
 * @author: xxx
 * @createTime: 2023/11/10 10:06
 * @project: xxx
 */
public class ConsulterPerformanceController extends AbstractViewController implements ActionListener {

    private ConsulterPerformanceView view;
    private AbstractModel model;

    private Gestion_BDD gestionBdd;

    public ConsulterPerformanceController(AbstractModel model, ConsulterPerformanceView view) {
